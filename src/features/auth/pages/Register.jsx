                  ...
                  <div className="mb-4">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className={`MuiButtonBase-root placify-input w-full rounded-xl border bg-[var(--bg-primary)] px-4 py-2.5 pr-11 text-sm outline-none placeholder:opacity-40 ${
                      ...
                      <button
                        ...
                        className="MuiButtonBase-root absolute right-3.5 top-1/2 -translate-y-1/2 opacity-50 hover:opacity-90 transition-opacity"
                        aria-label={
